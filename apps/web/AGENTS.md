...
La documentación viva del frontend está en `apps/web/docs/`: `README.md` indexa las piezas, `Vision.md` y `Requirements.md` describen alcance, y `Architecture.md` / `Frontend.md` describen la estructura actual.
