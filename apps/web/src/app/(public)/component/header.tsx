        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-2xl font-bold tracking-tight text-padel-green">
              Pádel<span className="text-(--background)">SAAS</span>
            </span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/register"
              className="bg-padel-green text-deep-onyx hover:bg-opacity-90 text-sm font-semibold px-4 py-2 rounded-lg shadow-md transition-all"
            >
              Registrate
            </Link>
          </div>
