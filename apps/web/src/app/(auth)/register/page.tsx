            ...
            <main className="flex-1">
                ...
                <section className="bg-deep-onyx pt-12 pb-24 text-center px-4">
                    <div className="max-w-4xl mx-auto space-y-2">
                        <h1 className="text-3xl md:text-4xl font-extrabold text-text-dark-main tracking-tight">Registro de jugador</h1>
                        ...
                        <form className="space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        <input type="text" placeholder="Ej: 35123456" className="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-gray-50/50 text-sm focus:outline-none focus:border-padel-green" />
                                    </div>
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-xs font-bold text-gray-500 uppercase">Contraseña (mín. 6 caracteres)</label>
                                        <input type="password" placeholder="******" className="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-gray-50/50 text-sm focus:outline-none focus:border-padel-green" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        <input type="text" placeholder="Ej: Juan Román" className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 text-sm focus:outline-none focus:border-padel-green" />
                                    </div>
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-xs font-bold text-gray-500 uppercase">Apellido</label>
                                        <input type="text" placeholder="Ej: Riquelme" className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 text-sm focus:outline-none focus:border-padel-green" />
                                    </div>
                                    <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <div className="flex flex-col gap-1.5">
                                            <label className="text-xs font-bold text-gray-500 uppercase tracking-wide">Fecha de Nacimiento</label>
                                            <div>
                                                <input type="date" name="Fecha de nacimiento" className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 text-sm focus:outline-none focus:border-padel-green appearance-none text-gray-700 cursor-pointer" />
                                            </div>
                                        </div>
                            ...
                            <div className="space-y-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                                ...
                                {sexoSeleccionado === "masculino" && (
                                    ...
                                    <div className="flex flex-col gap-1.5 animate-fadeIn">
                                        <label className="text-xs font-bold text-gray-500 uppercase tracking-wide">Categoria Caballeros</label>
                                        <div className="relative">
                                            <select name="categoria"
                                                ...
                                                <option value="caballeros septima">Caballeros Septima</option>
                                ...
                                {sexoSeleccionado === "femenino" && (
                                    <div className="flex flex-col gap-1.5 animate-fadeIn">
                                        <label className="text-xs font-bold text-gray-500 uppercase tracking-wide">Categoría Damas</label>
                                        <div className="relative">
                                            <select name="categoria"
                                                defaultValue=""
                                                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 text-sm focus:outline-none focus:border-padel-green appearance-none text-gray-700 cursor-pointer">
                                ...
                                {sexoSeleccionado === "" && (
                                    <p className="text-sm text-gray-400 italic bg-gray-50 p-3 rounded-xl border border-dashed border-gray-200 dark:border-gray-700">
                                        Por favor, selecciona tu sexo arriba para ver las categorías disponibles.
                                    </p>
                                )}
                            ...
                            <div className="space-y-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        <input type="text" placeholder="Ej: Argentina" className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 text-sm focus:outline-none focus:border-padel-green" />
                                    </div>
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-xs font-bold text-gray-500 uppercase">Provincia/Estado</label>
                                        <input type="text" placeholder="Ej: Buenos Aires" className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 text-sm focus:outline-none focus:border-padel-green" />
                                    </div>
                                    {/* Campo Combinado: Celular con código de país */}
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-xs font-bold text-gray-500 uppercase">Celular (Cod. Pais + numero)</label>
                                        <div className="flex gap-2">
                                            ...
                                            <input type="tel"
                                                name='celular' placeholder="xxxx-123456" className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 text-sm focus:outline-none focus:border-padel-green" />

                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-xs font-bold text-gray-500 uppercase">Telefono Emergencia</label>
                                        <input type="tel" placeholder="Fijo o celular" className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 text-sm focus:outline-none focus:border-padel-green" />
                                    </div>
                                </div>
                            ...
                            <div className="space-y-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-xs font-bold text-gray-500 uppercase tracking-wide">Brazo habil</label>
                                        <div className="flex bg-gray-50/75 p-1 rounded-xl border border-gray-200 dark:border-gray-700 h-10.5">
                                            ...
                                            <label className="flex-1 inline-flex items-center justify-center text-sm font-medium text-gray-700 dark:text-gray-600 rounded-lg cursor-pointer transition-all has-checked:bg-white has-checked:text-gray-900 has-checked:shadow-sm dark:has-checked:bg-gray-700 dark:has-checked:text-white">
                                                <input type="radio" name="brazoHabil" value="derecho" defaultChecked className="sr-only" />
                                                <span>Derecho</span>
                                            </label>

                                            {/* Opción: Izquierdo */}
                                            <label className="flex-1 inline-flex items-center justify-center text-sm font-medium text-gray-700 dark:text-gray-600 rounded-lg cursor-pointer transition-all has-checked:bg-white has-checked:text-gray-900 has-checked:shadow-sm dark:has-checked:bg-gray-700 dark:has-checked:text-white">
                                                <input type="radio" name="brazoHabil" value="izquierdo" className="sr-only" />
                                                <span>Izquierdo</span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-xs font-bold text-gray-500 uppercase tracking-wide">Posicion habitual</label>
                                        <div className="relative">
                                            <select name="posicionHabitual"
                                                defaultValue="derecha"
                                                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 text-sm focus:outline-none focus:border-padel-green appearance-none text-gray-700 cursor-pointer">
                                                <option value="" disabled hidden>Seleccione posicion en la cancha</option>
                                ...
                                <button type="submit" className="w-full mt-6 px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700  bg-deep-onyx text-xl font-bold tracking-wide transition-all duration-200 hover:border-padel-green hover:text-padel-green cursor-pointer shadow-md active:scale-[0.98] text-text-dark-main">Registrarse →</button>
                        </form>
                    </div>
                </section>
            </main>
